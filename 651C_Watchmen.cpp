//* 363032351	Feb/15/2026 19:29UTC+7	Minh4893IT	C - Watchmen	C++17 (GCC 7-32)	Accepted	781 ms	24500 KB
...
void solve()
{
    ...
    map<int, int> cntFst, cntSnd;
    map<int, map<int, int>> cntPair;
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        res += cntFst[a] + cntSnd[b] - cntPair[a][b];
        cntFst[a]++;
        cntSnd[b]++;
        cntPair[a][b]++;
    }
